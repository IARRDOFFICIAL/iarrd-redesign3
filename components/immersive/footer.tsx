...
const navigation = {
  domains: [
    { name: "Astronomy Systems", href: "/domains#astronomy" },
    { name: "Defence Platforms", href: "/domains#defense" },
    { name: "Marine Monitoring", href: "/domains#marine" },
    { name: "Rocketry Roadmaps", href: "/domains#rocketry" },
    { name: "Satellite Systems", href: "/domains#satellite" },
  ],
        ...
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">
              ...
              engineering initiative advancing indigenous capability across
              satellite systems, defence technologies, marine monitoring platforms,
              and applied space infrastructure.
