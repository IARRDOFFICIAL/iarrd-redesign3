        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="flex h-16 items-center justify-between lg:h-20">
            ...
            >
              ...
              <Image
                src="/logo/iarrd-logo.png"
                alt="IARRD Logo"
                width={150}
                height={40}
                priority
                className="h-9 w-auto object-contain transition-transform duration-300 hover:scale-[1.04] hover:drop-shadow-[0_0_6px_rgba(34,211,238,0.35)]"
              />
